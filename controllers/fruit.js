...
router.use((req, res, next) => {
  //req.session
  //check to see if the user is logged in via the req.session.loggedIn property. This property was define in the controller.user.js file
  //if the user is loggedIn we are going to use the next() which means allow the user to access the routes define below
...
router.post("/", async (req, res) => {
  ...
  //this ternary will update the readyToEat property value similar to how the
